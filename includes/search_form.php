                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center text-white">
                                ...
                                <form method="post" action="search.php?search=" class="cours-search">
                                    <div class="input-group">
                                        <input required name="search" type="text" class="form-control" placeholder="What do you want to learn today?	">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="cours-search-bx m-b30">
                                        ...
                                        <span class="cours-search-text">Learn Anythink In French 🎓.</span>
                                    </div>
                                </div>
                            </div>
                        </div>
