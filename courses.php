...
<?php include "includes/navigation.php"; ?>
        ...
        <div class="page-content bg-white">
                                ...
                                <div class="widget courses-search-bx placeani">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <button hidden name="submit" type="submit"></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
            ...
            <?php
                            ...
                            $count_course = "SELECT * FROM courses ";
                            $count = mysqli_query($connection,$count_course);
                            $find  = mysqli_num_rows($count);
                            $find  = ceil($find/9);

                            if($find < 1){

                                echo "<div class='alert alert-danger text-center text-capitalize text-danger' role='alert'>No courses available</div>";
                            }else{

                            $query = "SELECT * FROM courses LIMIT $page_1,9 ";
                                    ...
                                    <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
                                        <div class="cours-bx">
                                            <div class="action-box">
                                                ...
                                                <a href="course_details.php?source=details&c_id=<?php echo $course_id; ?>" class="btn">Read More</a>
                                            </div>
                                            <div class="info-bx text-center">
                                                <h5><a href="course_details.php?source=details&c_id=<?php echo $course_id; ?>"><?php echo $course_name; ?></a></h5>
                                            ...
                                            <?php
                                                for($i = 1; $i <= $find; $i ++){
                                                    ...
                                                    if($i == $page){
                                                        ...
                                                        echo "<li class='active' ><a class= 'active_link' href = 'courses.php?page={$i}'>{$i}</a></li>";
                                                    }else{
                                                        echo "<li ><a href = 'courses.php?page={$i}'> {$i}</a></li>";
                                                    }
